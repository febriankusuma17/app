		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Simple login form -->
					<form action="<?= base_url();?>index.php/Login_dokter/login" method="POST">
						<div class="panel panel-body login-form">
							...
							<div class="form-group has-feedback has-feedback-left">
								<input type="text" name="email_dokter" class="form-control" placeholder="Username atau Email">
							...
							<div class="form-group has-feedback has-feedback-left">
								<input type="password" name="password_dokter" class="form-control" placeholder="Password Dokter">
								<div class="form-control-feedback">
